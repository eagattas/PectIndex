...
##### Creating PDFs:  PDF's can be generated by going to File>Create PDF and a PDF will be created in the Downloads folder with the name of the file that was uploaded.
